...
export default class ActivityFeedComponent {
  ...
  readonly items = input<Activity[]>([
    { icon: 'âœ…', text: 'Deploy succeeded for remote-catalog', time: '2 min ago' },
    { icon: 'ðŸ”„', text: 'Registry sync completed', time: '5 min ago' },
    { icon: 'âš ï¸', text: 'High latency on remote-cart', time: '12 min ago', tone: 'warn' },
    { icon: 'âŒ', text: 'Health check failed', time: '1 hour ago', tone: 'err' },
  ]);
}
